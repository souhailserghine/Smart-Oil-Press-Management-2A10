...
private:
    ...
    QString resolveEmployeeNameForFingerprintId(int fingerprintId) const;
    void rememberFingerprintMapping(int fingerprintId, int employeeId) const;
    bool resolveEmployeeFromLocalMapping(int fingerprintId, int& employeeId, QString& fullName) const;
    ...
    QPushButton* m_enrollFingerprintBtn = nullptr;

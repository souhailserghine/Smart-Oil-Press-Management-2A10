...
bool Connection::createConnection() {
    db.setDatabaseName("Source_Projet2A");// saisissez le nom de votre source de données ici
    db.setUserName("mohamedbarrak");// saisissez votre nom d'utilisateur ici
    db.setPassword("Moniabarrak2001");// saisissez votre mot de passe utilisateur ici
